...
### http://zinc15.docking.org/substances/?highlight=CC%28C%29Cc1ccccc1&ecfp4_fp-tanimoto=CC%28C%29Cc1ccccc1
   pagename = "https://pubchem.ncbi.nlm.nih.gov/rest/pug/compound/fastsimilarity_2d/smiles/%s/JSON?Threshold=50&MaxRecords=100" % (urllib.quote_plus(SMILES[i]), tan_cutoff)
   print(pagename)
   cid_scrape_list=[]
   smiles_scrape_list=[]
   try:
